...
export const PhoneVoiceAnimation = () => {
  ...
  useEffect(() => {
    const generateWaveform = () => {
      const newWaveform = Array.from({ length: 18 }, () => 
        Math.random() * 0.8 + 0.2
      );
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      <div className="relative w-full max-w-44 h-full max-h-80 md:max-w-48 md:max-h-96 bg-gray-900 rounded-[28px] md:rounded-[32px] overflow-hidden border-4 md:border-6 border-gray-800 shadow-xl">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-20 md:w-24 h-3 md:h-4 bg-black rounded-b-lg z-10"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col">
          <div className="h-8 md:h-10 bg-gradient-to-r from-primary/80 to-purple-600/80 flex items-center justify-center">
          ...
          <div className="flex-1 p-2 md:p-3 flex flex-col">
            {animationStage === 0 && (
              ...
              >
                ...
                <div className="w-full h-12 md:h-16 flex items-center justify-center gap-0.5 md:gap-1 mb-4 md:mb-6">
                ...
                <motion.div 
                  className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-red-500 flex items-center justify-center mb-2 md:mb-3"
            ...
            {animationStage === 1 && (
              <motion.div 
                ...
                className="flex-1 flex flex-col items-center justify-center"
              >
                <div className="text-white text-center mb-4 md:mb-6">
                  <span className="text-xs">
                    <TranslatableText text="Processing your entry..." />
                  </span>
                </div>
                <motion.div 
                  className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-purple-600/30 flex items-center justify-center"
                  animate={{ 
                    scale: [1, 1.2, 1],
                    rotate: [0, 360],
                ...
                <div className="mt-4 md:mt-6 flex gap-1 md:gap-2">
              ...
              >
                ...
                <div className="space-y-1.5 md:space-y-2">
                  ...
                  <motion.div
                    ...
                    className="bg-gray-800/80 p-1.5 md:p-2 rounded-md border border-gray-700"
                  >
                    <div className="flex items-center gap-1.5 md:gap-2 mb-1">
                      <div className="min-w-3 h-3 md:min-w-4 md:h-4 rounded-full bg-primary/20 flex items-center justify-center">
                        <LineChart className="h-1.5 w-1.5 md:h-2 md:w-2 text-primary" />
                      </div>
                      <p className="text-white text-xs">
                        <TranslatableText text="Emotional patterns" />
                      </p>
                    </div>
                    <div className="h-[30px] md:h-[40px] mt-1">
                  ...
                  >
                    <div className="flex items-center gap-1.5 md:gap-2 mb-1">
                      <div className="min-w-3 h-3 md:min-w-4 md:h-4 rounded-full bg-primary/20 flex items-center justify-center">
                        <TrendingUp className="h-1.5 w-1.5 md:h-2 md:w-2 text-primary" />
                      </div>
                      <p className="text-white text-xs">
                ...
                <motion.div 
                  className="mt-auto mb-2 md:mb-3 w-full bg-primary/20 p-1.5 md:p-2 rounded-md flex items-center justify-between"
                ...
                >
                  ...
                  <ArrowRight className="h-2.5 w-2.5 md:h-3 md:w-3 text-primary" />
                </motion.div>
              </motion.div>
            )}
          </div>
          <div className="h-10 md:h-12 border-t border-gray-800 flex justify-around items-center px-2 md:px-3">

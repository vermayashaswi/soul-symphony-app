...
import SoulNetVisualization from './SoulNetVisualization';
import { LoadingState } from './LoadingState';
import { EmptyState } from './EmptyState';
import { FullscreenWrapper } from './FullscreenWrapper';
import SoulNetDescription from './SoulNetDescription';
...
const SoulNet: React.FC<SoulNetProps> = ({ userId, timeRange }) => {
  ...
  // Updated shouldShowLabels logic - always show labels by default for better UX

...
export function FloatingDotsToggle({ onClick }: FloatingDotsToggleProps) {
  return (
    <div className="flex items-center gap-2">
      ...
      {/* "Themes" text with colored letters */}
      <div 
        className="text-sm font-medium cursor-pointer"
        onClick={onClick}
        style={{ letterSpacing: '0.5px' }}
      >
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">T</span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">H</span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-400">E</span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-green-400">M</span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-cyan-500">E</span>
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-500">S</span>
      </div>
    </div>
  );
}

...
const JournalDebugger = ({
  ...
  if (!isOpen) {
    return (
      <div 
        className="fixed bottom-4 right-4 z-50 bg-yellow-500 text-black p-2 rounded-full cursor-pointer shadow-lg hover:bg-yellow-400 transition-colors"
        onClick={toggleOpen}
      >
        <Code size={20} />
      </div>
  ...
  return (
    <motion.div 
      className="fixed bottom-4 right-4 z-50 bg-gray-950 text-white p-4 rounded-lg shadow-xl border border-yellow-500 max-w-[90vw]"

...
interface SouloLogoProps {
  ...
  splashMode?: boolean; // New prop for splash screen styling
}
...
const SouloLogo = ({
  ...
  // Apply color theme if useColorTheme is true, with special handling for splash mode
  const getThemeTextClass = () => {
    if (splashMode) {
      return "text-purple-600"; // Fixed purple theme for splash
    }
    return useColorTheme ? "text-primary" : "";
  };

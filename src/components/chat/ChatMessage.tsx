            ...
            <AnimatePresence>
              {showReferences && (
                <motion.div
                  ...
                  className="absolute bottom-9 left-0 mb-1 max-h-40 md:max-h-60 overflow-y-auto border border-fuchsia-500/30 rounded-md p-2 bg-gray-900/90 backdrop-blur-sm w-72"
                >

...
export const supabase = createClient<Database>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  ...
  // Explicitly set storage configuration
  storage: {
    // Avoid any custom configuration that might interfere with default behavior
  }
});
...
// Check if the audio bucket exists and is accessible

      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Voice Journaling</h2>
            <p className="text-muted-foreground mb-6">
              Record your thoughts with voice and let SOULo transcribe and analyze them automatically.
            </p>

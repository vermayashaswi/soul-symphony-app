...
import MobileNavigationManager from '@/components/navigation/MobileNavigationManager';
...
const AppRoutes = () => {
  ...
  const AppRootRedirect = () => {
    ...
    if (user) {
      ...
      // If user is not logged in, go to onboarding (public)
  ...
  return (
    <>
      ...
      {/* Mobile Navigation Manager - renders outside routes */}

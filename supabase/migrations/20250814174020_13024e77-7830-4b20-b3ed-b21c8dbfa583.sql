-- Security hardening: Add search_path to all database functions for SQL injection protection

-- Fix function: update_session_updated_at
...
-- Fix function: get_journal_entry_count
...
-- Fix function: resume_or_create_session
...
-- Fix function: cleanup_idle_sessions
...
-- Fix function: extend_session_activity
...
-- Fix function: get_time_of_day_distribution
...
-- Fix function: get_active_themes
...
-- Fix function: match_journal_entries (with user_id parameter)

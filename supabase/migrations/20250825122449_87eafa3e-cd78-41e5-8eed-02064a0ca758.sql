-- Fix the schedule_journal_reminders function with proper variable types
    ...
    IF jsonb_typeof(user_record.reminder_settings->'reminders') = 'array' THEN
      ...
      LOOP
        ...
        IF (reminder_record.reminder_data->>'enabled')::boolean = true THEN
          ...
          -- Cast current_time explicitly to ensure proper comparison
          IF scheduled_time <= current_time::timestamp with time zone THEN

...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Using model: gpt-4o-transcribe"); // Updated model name from mini to regular
    ...
    try {
      // Transcribe audio with the correct model name
      console.log("Sending audio to OpenAI API for transcription");
      console.log("Using model: gpt-4o-transcribe"); // Updated model name

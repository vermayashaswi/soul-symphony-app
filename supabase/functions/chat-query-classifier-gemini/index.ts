...
- "What should I do?" type questions → GENERAL_MENTAL_HEALTH (unless specifically asking to analyze journal data)
  ...
  You need to generate an output as below, depending on the conversation history that's provided to you. Your objective is to ensure, user's queries/concerns/asks are all met. You need to accordingly classify since you know what happens downstream post your classification

...
/* Master themes are dynamically fetched from the database at runtime; no hardcoded list here. */

/* Master emotions are dynamically fetched from the database at runtime; no hardcoded list here. */
...
3. **Canonical Emotion Terms**
   - Use ONLY the canonical emotion names defined in the emotions master table
   - The active list will be provided dynamically at runtime; do not assume or invent terms
